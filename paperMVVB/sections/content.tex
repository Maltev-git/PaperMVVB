...
\begin{figure}
	...
	\caption{Estimated solar wind parameter medians (black) and their error bands (grey) during SPP's first perihelion in 2018. For the velocity slow and fast part are plotted.}
...
\begin{figure}
	...
	\caption{Estimated solar wind parameter medians (black) and their error bands (grey) during SPP's nearest perihelion in 2024. For the velocity slow and fast part are plotted.}
