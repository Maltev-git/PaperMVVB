...
\begin{table*}
	...
	S[table-format = 1.3(2)]}
		\hline\hline
		\multicolumn{2}{l}{\multirow{2}{*}{Parameter}}	&\multicolumn{1}{c}{Median}	&\multicolumn{1}{c}{Mean}	&\multicolumn{1}{c}{Exponent}	&\multicolumn{1}{c}{Balance}\\
...
\subsection{SSN prediction for SPP mission time}
%SSN prediction
...
\subsection{SPP solar wind environment estimation}
