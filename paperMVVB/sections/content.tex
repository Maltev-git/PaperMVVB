...
\begin{itemize}
	...
	\item Averaging over fast and slow solar wind streams, the derived median velocity value dependence is
	\begin{align}
		v_\text{med}(ssn,r) = \left(\SI{1.31}{\km\per\s} \cdot ssn + \SI{429}{\km\per\s}\right) \cdot r^{0.099}	\,.
	\end{align}
	This relation is valid above about \SI{20}{\Rs}, below this solar distance it overestimates the actual velocities obtained from remote measurements. The estimated median values for PSP's first and closest perihelion are \SI{340}{\km\per\s} and \SI{290}{\km\per\s}.
	...
	\end{align}
	Near PSP's perihelion the validity of this relation is difficult to evaluate. The estimated median values for PSP's first and closest perihelion are \SI{503000}{\K} and \SI{1930000}{\K}.
\end{itemize}
