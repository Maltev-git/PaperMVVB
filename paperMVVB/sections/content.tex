...
\end{itemize}
The overestimation of the extrapolated velocity and temperature values at distances below \SI{20}{\Rs} indicate the occurrence of solar wind acceleration and heating processes, which PSP will thus be able to directly measure as planned.
